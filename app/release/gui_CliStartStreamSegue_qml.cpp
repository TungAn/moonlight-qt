...
0x0,0x1d,0x0,0x0,0x63,0x31,0x31,0x35,
...
#endif
while (!aotContext->loadScopeObjectPropertyLookup(49, &v2_0)) {
#ifdef QT_NO_DEBUG
aotContext->setInstructionPointer(2);
#endif
...
v2_0 = QStringLiteral("Are you sure you want to quit %1\? Any unsaved progress will be lost.");
{
}
// generate_StoreReg
{
...
v2_4 = QCoreApplication::translate(aotContext->translationContext().toUtf8().constData(), std::move(v2_0).toUtf8().constData(), "", -1);
{
}
// generate_StoreReg
{
...
#endif
while (!aotContext->loadScopeObjectPropertyLookup(59, &v2_10)) {
#ifdef QT_NO_DEBUG
aotContext->setInstructionPointer(12);
#endif
...
v2_14 = std::move(v2_4).arg(std::move(v2_10));
{
}
{
}
// generate_Ret
if (argv[0]) {
    *static_cast<QString *>(argv[0]) = std::move(v2_14);
}
return;
}
 },{ 0, 0, nullptr, nullptr }};
